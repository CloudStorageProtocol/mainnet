...
import static com.uranus.library_wallet.base.eth.WalletManager.getWeb3j;
...
public class WalletUtils {
     ...
     * @param keystore
     */
    public static Wallet fromKeyStore(String password, String keystore) throws CipherException, IOException{
        ...
        Lmsg.d("dddd--json---" + json);
        return new Wallet("", EthUtils.getAddress(ecKeyPair), privateKey, publicKey, json);
    }
     ...
     * @return
     */
    public Flowable<Wallet> importKeystore(Context context, String keystore, String password, String walletName) {
